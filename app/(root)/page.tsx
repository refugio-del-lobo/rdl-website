  ...
  return (
    <div className=" bg-casa-lejos-bg bg-center">
      <div className="w-full h-full opacity-layer-70 hf-paddings">
        <div className="wrapper min-h-screen flex flex-col justify-between md:gap-0">
          ...
          <div className=" flex flex-col text-right w-full px-2 tracking-wide drop-shadow-md hero-text">
            <p className="w-full md:w-9/12 self-end">Te invitamos a vivir experiencias inolvidables, paisajes impresionantes y una gastronomía con un toque hogareño</p>
          </div>
        </div>
            ...
            <div className="flex-col justify-between text-2xl flex w-full md:w-6/12 p-6">
                  ...
                  <ul className="flex flex-col gap-2 text-start">
                    ...
                    <li className="flex items-center gap-2">
                      ...
                      <p>
                        ...
                        <span className="text-lg text-gray-500">
                          {"("}in-out Aeropuerto o terminal de ómnibus / Cerro Chapelco / Otros{")"}
                        </span>
                      </p>
                    </li>
              ...
              <div className="flex flex-wrap w-full mt-4 home-thumb-section opacity-layer-70">
                <div className="home-thumb-img">
                  <Image
                    src="/assets/images/home_office.jpg"
                    width={300}
                    height={300}
                ...
                <div className="home-thumb-img">
                  <Image
                    src="/assets/images/4_comidas.jpg"
                    width={300}
                    height={300}
                    alt="logo de Refugio del Lobo"
                    className="thumb-img"
                ...
                <div className="home-thumb-img">
                  <Image
                    src="/assets/images/house_keeping.jpg"
                    width={300}
                    height={300}
                    alt="logo de Refugio del Lobo"
                    className="thumb-img"
